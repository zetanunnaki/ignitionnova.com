...
export const metadata: Metadata = {
  title: "Our Services",
  description:
    "From Generative Engine Optimization to Technical SEO, Web Development, and CRO—explore our full suite of 2026-ready digital marketing services.",
  alternates: { canonical: "https://www.ignitionnova.com/services" },
  openGraph: {
    title: "Digital Marketing Services | Ignition Nova",
    description: "From Generative Engine Optimization to Technical SEO, Web Development, and CRO—explore our full suite of 2026-ready digital marketing services.",
    url: "https://www.ignitionnova.com/services",
  },
};
    ...
    <>
      <section className="relative pt-40 pb-24 overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          ...
          <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full bg-accent-cyan/10 blur-[150px]" />
        </div>
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-8">
          <AnimateIn>
            <div className="inline-flex items-center gap-2 bg-accent/10 border border-accent/20 rounded-full px-4 py-1.5 mb-6">
              <span className="w-1.5 h-1.5 rounded-full bg-accent" />
              <span className="text-accent-light text-xs font-semibold uppercase tracking-widest">Our Services</span>
            </div>
            ...
            <p className="text-white/50 text-xl max-w-2xl leading-relaxed font-light">
              Enjoy seeing your website climb the search rankings with Ignition
              Nova&apos;s advanced and expertly crafted SEO services. We combine
              cutting-edge technology with proven methodologies.
            </p>
          </AnimateIn>
        </div>
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-6 lg:px-8 text-center">
          <AnimateIn>
            ...
            <p className="text-white/40 text-xl mb-12 font-light leading-relaxed max-w-2xl mx-auto">
              Book a free strategy call and we&apos;ll audit your current digital
              presence to recommend the highest-impact starting point.
            </p>
            <Link
              href="/contact"
